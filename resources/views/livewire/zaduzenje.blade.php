                            ...
                            @if ($data->count())
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="px-2 pr-2">
                                            <a class="flex hover:text-red-500" href="{{ route( 'zaduzenje-distributeri', ['id' => $item->id] ) }}" :active="request()->routeIs('zaduzenje-distributeri', ['id' => $item->id])" title="Distributeri">
