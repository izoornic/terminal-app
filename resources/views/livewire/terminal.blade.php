<div class="p-6">
    ...
    <x-jet-dialog-modal wire:model="newTiketVisible">
        ...
        @if($newTiketVisible)
           ...
           @if(App\Models\Tiket::daliTerminalImaOtvorenTiket($newTiketTerminalId))
                {{-- PRIKAZ GRESKE --}}
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative my-4" role="alert">
                    <strong class="font-bold">Greška!</strong>
                    <span class="block sm:inline">Terminal ima aktivan Tiket. Otvoren: {{ App\Http\Helpers::datumFormat(App\Models\Tiket::daliTerminalImaOtvorenTiket($newTiketTerminalId)->created_at) }}</span>
        ...
        <x-slot name="footer">
            ...
            @if($userPozicija != 2)
                ...
                @endif 
            @else
                @if($prioritetTiketa && !App\Models\Tiket::daliTerminalImaOtvorenTiket($newTiketTerminalId))
