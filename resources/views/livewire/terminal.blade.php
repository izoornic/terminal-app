                ...
                <div class="bg-sky-100 border-t-4 border-sky-500 rounded-b text-sky-900 px-4 py-3 shadow-md mb-6" role="alert">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <p class="text-sm">Poslednja promena: <span class="font-bold">{{ $this->datumFormat($selectedTerminal->updated_at) }}</span></p>
                        </div>
                    </div>
                </div> 
                @if($historyData->count())
                    <ol class="relative border-l border-gray-200 dark:border-gray-700">
                        ...
                        <li class="mb-4 ml-6">            
                            ...
                            <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white"> - <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">{{ $this->datumFormat($item->updated_at) }}</span></h3>
