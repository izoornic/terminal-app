                    ...
                    <table class="min-w-full divide-y divide-gray-200" style="width: 100% !important">
                        <thead>
                            <tr>
                                ...
                                <th class="px-2 py-2 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            ...
                            @if ($data->count())
                                @foreach ($data as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <x-jet-secondary-button wire:click="changeDatesVisible({{$item->ldtid}})" title="Promeni datume">
        ...
        <div class="bg-sky-100 border-t-4 border-sky-500 rounded-b text-sky-900 px-4 py-3 shadow-md mb-6" role="alert">
            <div class="flex justify-between">
                ...
                <div class="py-1">
                    ...
                    <p class="text-sm">Srednji kurs evra: @money($mesecRow->srednji_kurs)</p>
                </div>
                <div class="py-1">
